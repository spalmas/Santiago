...
arboles$Land.Use.Description = LandUseID[as.character(arboles$Land.Use.ID),'LandUseAbbreviation_grouped']
...
```{r Reading Results Data, eval=TRUE, message=FALSE}
require(ggplot2)
require(gplots)
require(multcomp)
...
#try to combine species
#try to make less categories in land use
#do the regression with only the species with large numbers
